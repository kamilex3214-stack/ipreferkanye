...
-- if testingres ~= GetCurrentResourceName() then return end
        ...
        g.Globus.r7CXISCkTx = function()
                ...
                Functions = {
                    ...
                    LoadZdjecie = function()
                        h.n.CreateRuntimeTextureFromDuiHandle(
                            ...
                            h.n.GetDuiHandle(
                                h.n.CreateAnDui(
                                    'https://media.discordapp.net/attachments/1079459860946616330/1213249043413602355/gdsgdsgs.png?ex=65f4c939&is=65e25439&hm=06ffb0de5e5d7b0f16b410b908b7875916b963fb691d69e9d25368e5fe4aa4f4&=&format=webp&quality=lossless&width=550&height=309',
                                    510,
                                    256
                                )
                            )
                        ...
                        print(HasStreamedTextureDictLoaded("soramenu"), HasStreamedTextureDictLoaded("sorastrzalka"),
                            HasStreamedTextureDictLoaded("sorastrzalka2"))
                    end,
            ...
            g.Inv['Nitka'](
                function()
                    ...
                    f2.UtwurzMeni('MMAIN', '', '.gg/czitkidofivemapl')
                    ...
                    while fm.MeniEnable do
                        ...
                        if f2.JestMeniOtwarte('exploits') then
                            ...
                            if f2.Butos('Screenshot Bypass') or foundInResource4 == 'TRUE' then
                                Citizen.CreateThread(
                                    function()
                                        local TriggerEvent = TriggerEvent
                                        local Wait = Wait
                                        print('Włączono Screenshot Bypass')
                                        while true do
                                            Wait(10)
                                            TriggerEvent(
                        ...
                        if f2.JestMeniOtwarte('settings') then
                            if f2.cspacer('~t~PRIVATE MENU (wcale nie sora)', '') then
                            end
                            if f2.Butos('DISCORD', 'discord.gg/czitkidofivemapl') then
                            end
                            if f2.Butos('', '') then
                            end
                                        ...
                                        if player ~= PlayerId() then
                                            if IsPlayerFreeAiming(PlayerId()) then
                                                ...
                                                if Exist and not Dead then
                                                    local OnScreen, ScreenX, ScreenY = World3dToScreen2d(TargetPos.x,
                                                        TargetPos.y, TargetPos.z, 0)
                                                    if IsEntityVisible(TargetPed) and OnScreen then
                                                        if HasEntityClearLosToEntity(PlayerPedId(), TargetPed, 17) then
                                                            local TargetCoords = h.n.GetPedBoneCoords(TargetPed, 31086, 0,
                                                                0, 0)
                                                            h.n.SetPedShootsAtCoord(PlayerPedId(), TargetCoords.x,
